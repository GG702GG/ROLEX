...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Gold-So/Files_ROLEX/main/File_Bot/commands.lua") 
...
if DevROLEXW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Gold-So/Files_ROLEX/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Gold-So/Files_ROLEX/main/File_Bot/"..file)
if res == 200 then
...
send(msg.chat_id_, msg.id_, t..'ٴ◈∫ٴ*•━━━━━━ Gold ━━━━━━━•*ٴ◈∫○ٴ\n◈︙[𝙎𝙤𝙪𝙧𝘾𝙚 𝙍𝙤𝙡𝙚𝙭.](t.me/kksili) ')
end
